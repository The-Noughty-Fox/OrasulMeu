...
public struct UserDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Double, firstname: String, lastname: String, email: String, gender: Gender, googleToken: String? = nil, facebookToken: String? = nil, appleToken: String? = nil, activities: [String], media: [String], friends: [String], interests: [String]) {
        self.id = id
