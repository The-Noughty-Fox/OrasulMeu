...
//                        .package(url: "https://github.com/The-Noughty-Fox/noughty-environment-lib-swift.git", from: .init(0, 0, 2)),
//                        .package(url: "https://github.com/The-Noughty-Fox/noughty-ui-lib-swift.git", from: .init(0, 0, 2)),
                        .package(path: "../generated/api"),
                        .package(path: "../../../noughty-environment-lib-swift"),
                        .package(path: "../../../noughty-ui-lib-swift"),
                      ]
)
